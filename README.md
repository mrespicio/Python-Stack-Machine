...
<b>Prog4_1:</b>Takes a single command line argument, which is the name of a text file. Program reads file and prints the text word by word separated by a comma. </br>
